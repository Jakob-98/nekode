...
private let logger = Logger(subsystem: "com.jakobserlier.CatAssistant", category: "PluginManager")
...
class PluginManager: ObservableObject {
    ...
    private static let ocPluginPath = home.appendingPathComponent(".config/opencode/plugins/catassistant.js")
    private static let copilotHooksDir = home.appendingPathComponent(".cat/plugins/copilot/hooks")
    ...
    func refresh() {
        ...
        let ccDir = home.appendingPathComponent(".claude/plugins/cache/catassistant")
    ...
    func installCopilotHooks() -> Bool {
        ...
        do {
            // 1. Copy hook files to ~/.cat/plugins/copilot/hooks/
    ...
    private static let copilotHooksLocationValue = "~/.cat/plugins/copilot/hooks"
