...
extension Session {
    ...
    static let mockSessions: [Session] = {
        var s1 = mock(
            id: "1", project: "catassistant", branch: "pid-keyed-sessions",
            sessionName: "migrate-off-session-id",
            status: .working, lastTool: "Edit",
            lastToolDetail: "/Users/test/projects/catassistant/CLAUDE.md"
        )
        ...
        var s3 = mock(
            id: "3", project: "catassistant", branch: "pid-keyed-sessions",
            sessionName: "Dave", status: .idle
        )
        s3.lastActivity = Date().addingTimeInterval(-5) // shows "5s ago"

        var s4 = mock(
            id: "4", project: "catassistant", branch: "pid-keyed-sessions",
            status: .idle
        )
    ...
    static let qaLongSessionNames: [Session] = [
        .mock(id: "1", project: "catassistant",
               branch: "redesign",
               sessionName: "Can you use test data to show me what happens if the session name is super long like over 50 characters",
               status: .working, lastTool: "Edit",
               lastToolDetail: "/Users/test/projects/catassistant/Views/SessionCardView.swift"),
        .mock(id: "2", project: "catassistant",
               branch: "main",
    ...
    static let qaShowcase: [Session] = [
        .mock(id: "1", project: "catassistant", branch: "main",
