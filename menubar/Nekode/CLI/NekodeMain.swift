...
struct NekodeMain {
    ...
    private static func printTopLevelHelp() {
        print("nekode \(version)")
        print("Desktop pets for your coding agents.\n")
        print("USAGE:")
...
enum HookCommand {
    ...
    private static func printHelp() {
        ...
        print("This subcommand is called by Claude Code and VS Code Copilot hooks")
...
enum WaitCommand {
    ...
    private static func printHelp() {
        ...
        print("as a live session in the Nekode menubar and desktop pets.\n")
        print("USAGE:")
