...
DOWNLOAD_URL_PREFIX="https://github.com/Jakob-98/nekode/releases/download/v${VERSION}/"
FEED_URL="https://raw.githubusercontent.com/Jakob-98/nekode/main/appcast.xml"
