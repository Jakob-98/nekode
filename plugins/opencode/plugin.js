// Nekode plugin for opencode
// Writes session state to ~/.nekode/sessions/{pid}.json for the Nekode menubar app.
...
const SESSIONS_DIR = join(homedir(), ".nekode", "sessions");
...
export const nekode = async ({ directory }) => {
